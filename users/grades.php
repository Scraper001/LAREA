...
<main class="min-h-screen main-font bg-gray-50">
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 p-4 shadow-sm grade-card">
                        ...
                        <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <button onclick="deleteGrade(<?= $grade['grade_id'] ?>, '<?= htmlspecialchars($grade['assessment_name']) ?>')"
            ...
            <form id="addGradeForm" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <input type="number" id="gradeMaxPoints" name="max_points" required min="1" step="0.01" value="100"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            placeholder="100">
                    </div>
                </div>
    ...
    <div id="addAnecdotalModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 hidden">
        <div class="relative top-10 mx-auto p-5 border w-11/12 max-w-md shadow-lg rounded-md bg-white">
            <!-- Modal Header -->
            <div class="flex items-center justify-between mb-4">
